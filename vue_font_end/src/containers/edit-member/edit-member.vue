  ...
  <div class="edit-member">
    ...
    <Form ref="editData" :model="editData" :label-width="40" v-if="editData" label-position="left">
      ...
      <FormItem label="账户" prop="account">
        <Input v-model="editData.account" placeholder="请输入账户"/>
      </FormItem>
      <FormItem label="角色" prop="role">
        <Select v-model="editData.roleId" placeholder="请选择角色" @on-change = 'roleChange'>
      ...
      <FormItem label="电话" prop="phone">
        <Input v-model="editData.phone" placeholder="请输入电话"/>
      </FormItem>
